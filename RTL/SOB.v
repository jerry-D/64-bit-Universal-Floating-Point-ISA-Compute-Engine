...
//`define SOB_has_Fat_Bus              //if defined, this increases external Data-Pool Host CPU interface bus width from 64 bits to 1024 bits
//`define SOB_has_external_SRAM        //if defined, this will instantiate an external Synchronous SRAM interface in the SOB and a GSI Technology
                                       //NBT (No Bus Turn Around) Flow Through Mode Synchronous x64-Bit SRAM (GSI8320ZxxAGT) in the test bench
module SOB (
   CLK,
   RESET_IN,
